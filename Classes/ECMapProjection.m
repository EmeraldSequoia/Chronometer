...
//  Emerald Chronometer
//
//  Created by Bill Arnett on 3/11/2010.
//  Copyright 2010 Emerald Sequoia LLC. All rights reserved.
//

typedef struct Robinson_COEFS {
    float c0, c1, c2, c3;
} Robinson_COEFS;

static Robinson_COEFS robX[] = {
...
void forwardRobinson(double lat, double lng, double *x, double *y) {
    int i;
    double dphi;
    lat = lat * M_PI/180;
    lng = lng * M_PI/180;
    ...
    dphi =180. / M_PI * (dphi - RC1 * i);
    *x = RFUDGE * V(robX[i], dphi) * FXC * lng * 180/M_PI;
    *y = RFUDGE * V(robY[i], dphi) * FYC * 180/M_PI;
    if (lat < 0.) {
	*y = -*y;
    }
}
